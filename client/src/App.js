...
import UserProfile2 from './components/UserProfile/UserProfile'
import { ProtectedRoute } from './protected.route'
import {  BarberRoute } from './barber.route'
import ProfileComponent from './components/BarberProfile/BarberProfile';
    ...
    <div className="App">
      <Router>
        <Switch>
          ...
          <ProtectedRoute component={UserProfile2} path='/profile' />
          <ProtectedRoute component={UserAppointment} path='/userapp' />

          <BarberRoute component={ProfileComponent} path='/bprofile' />
