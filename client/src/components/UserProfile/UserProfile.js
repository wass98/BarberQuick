...
const UserProfile = (props) => {
    ...
    const getProfile = (userID) =>{
        ...
        axios.get(`http://localhost:5000/userappointment?id=${userID}`).then((response) =>{
            ...
            let {error, day, time, date, status } = response.data 
            if(error){
                console.log(error)
            }
            else{
            ...
            <div className='user-profile-container'>
                <div className='user-profile-left'>
                    ...
                    <ul>
                        <li className='profile-make-appointment'>
                            ...
                            <Link className='link-make-appo' to='/barberlist'>
                                MAKE APPOINTMENT
                            </Link>
                        </li>
                        <li>
                ...
                <div className='user-profile-right'>
                            ...
                            {time !== 'Empty' ? (
                                <div className='user-profile-appointment'>
                                    <div className='user-profile-appointment-flex'>
                                        ...
                                        <div 
                                        className='user-profile-appointment-status'
                                        style={{ backgroundColor: status === 'pending' ? 'grey' : 'rgb(45, 207, 67)' }}
                                        >
                                        <p>{status}</p>
                                        </div>
                                    </div>     
                    ...
                    <div id='user-profile-delete-acc' className='user-profile-box'>
                        ...
                        <p>
                            Once Deleted, you can't back it up.
                        </p>
